...
<form action ="/aftersignup" method="post">
	<input type ="hidden" name="t_call" value= ${t_call} />
	<input type ="hidden" name="t_pwd" value=${t_pwd} />
    <div class="signup-form2">

      <div class="teamname-row row">
        <input type="text" name = "t_name" style="text-align:center;" maxlength="10" id="team_name_set" class="teamname-input" placeholder="팀 명"></input>
      </div>



      <div class="yourname-row row">
        <input type="text" name = "t_leader" style="text-align:center;" maxlength="5" id="yourname_set" class="yourname-input" placeholder="팀장 이름"></input>
      </div>



      <div class="area-row row">
	    <select name="t_place" id="area_set" class="form-control">
      ...
      <div class="time-row row">
	    <select name=t_time id="time_set" class="form-control">
      ...
      <div class="power-row row">
	    <select name="t_power" id="power_set" class="form-control">
    ...
    <div class="call-to-actions">
      <button id="signup1-button" type="submit" >회원가입하기</button>
...
<script src='https://cdn.jsdelivr.net/velocity/1.2.2/velocity.ui.min.js'></script>
    ...
    <script  src="assets/js/signup2.js"></script>
