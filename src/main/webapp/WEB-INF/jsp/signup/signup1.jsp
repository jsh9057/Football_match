...
<div class="container">
  <div id="login" class="login">
    ...
    <div class="login-form">
      ...
      <div class="phonenumber-row row">
        <label for="phonenumber_set">
        ...
        <input type="tel" name="call" maxlength="13" id="call_box" class="username-input" placeholder="핸드폰 번호 등록"></input>
      </div>
      ...
      <div class="password-row row">
        ...
        <input type="password" type="button" maxlength="12" id="pwd_box" class="password-set" class="input" placeholder="패스워드 등록(12글자 이하)"></input>
      </div>
       ...
       <div class="password-row row">
        ...
        <input type="password" type="button" maxlength="12" id="pwd_box2" class="password-set" class="input" placeholder="패스워드 확인"></input>
      </div>
    </div>

<br><br><br>
	<button id="callcheck-button" class="btn" >핸드폰 번호 중복 확인</button>
    <div class="call-to-action">
      <button id="callregist-button" class="btn" >팀 등록</button>
      <br><br>
      <p><font size="1em">핸드폰 번호와 비밀번호를 입력해 주세요.</font></p>
      <p><font size="1em">이미 회원가입이 되어있으신가요?<a href="#">로그인</a></font></p>
    </div>
